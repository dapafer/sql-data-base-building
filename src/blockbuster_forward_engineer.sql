...
CREATE TABLE IF NOT EXISTS `blockbuster`.`actors_films` (
  ...
  INDEX `fk_actors_films_actors1_idx` (`actor_id` ASC) VISIBLE,
  CONSTRAINT `fk_actors_films_films1`
    FOREIGN KEY (`film_id`)
    REFERENCES `blockbuster`.`films` (`film_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_actors_films_actors1`
...
CREATE TABLE IF NOT EXISTS `blockbuster`.`staff` (
  ...
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `personal_ID` VARCHAR(20) NULL DEFAULT NULL,
  `phone_number` VARCHAR(20) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `blockbuster`.`rentals` (
  ...
  INDEX `fk_rentals_customers_idx` (`customer_id` ASC) VISIBLE,
